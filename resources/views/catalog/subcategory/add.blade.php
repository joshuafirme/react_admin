        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/ofw_admin/catalog/subcategories">Sub-Category</a></li>
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          ...
                          <div class="form-group">
                            ...
                            <input id="subcategory_name" type="text" required name="subcategory_name" class="form-control" autocomplete="off">
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <!-- text input -->
                          <div class="form-group">
                            ...
                            <input id="subcategory_description" type="text" name="subcategory_description" class="form-control" autocomplete="off">
                          </div>
                         </div>
                        <div class="col-sm-6">
                          <!-- select -->
  ...
  <!-- /.content-wrapper -->
    <script>
        ...
        $("#btn-submit").click(function(e){
            ...
            $.ajax({
               type: 'POST',
               url: '/ofw_admin/catalog/subcategories/store',
