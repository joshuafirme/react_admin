                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="form-group">
                            ...
                            <label>Employee No / User No</label>

                            <input id="employee_no" type="text" required name="employee_no" class="form-control" placeholder="Enter Employee No / User No" autocomplete="off">
