        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              <li class="breadcrumb-item"><a href="/catalog/announcements">Announcement</a></li>
                    ...
                    <form id="form-advertisement" role="form" _lpchecked="1">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <!-- select -->
                          <div class="form-group">
                            <label>Select Announcement Type</label>
                          ...
                          <div class="form-group">
                            <label>Announcement Image</label>
                              @if($advertisements->ads_img)
                                <img id="image-attached" src="/public{{$advertisements->ads_img}}" style="width: 100%;" alt="ads_img"/>
                              @else
  ...
  <!-- /.content-wrapper -->
    <script>
        ...
        $("#btn-submit").click(function(e){
            ...
            $.ajax({
               type: 'POST',
               url: '/catalog/announcements/update',
               ...
               success:function(data){
                   ...
                   if(document.getElementById("ads_img").files.length != 0){
                        ...
                        $.ajax({
                            type: 'POST',
                            url: '/catalog/announcements/uploadAnnouncementFiles',
                            data:  attachmentForm,
                            dataType: "text",
