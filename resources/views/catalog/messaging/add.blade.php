                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          ...
                          <div class="form-group">
                            ...
                            <input id="agency_name" type="text" required name="agency_name" class="form-control" autocomplete="off">
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <!-- text input -->
                          <div class="form-group">
                            ...
                            <input id="agency_description" type="text" name="agency_description" class="form-control" autocomplete="off">
                          </div>
                         </div>
                        <div class="col-sm-6">
                          <!-- text input -->
                          <div class="form-group">
                            ...
                            <input id="agency_email" type="text" name="agency_email" class="form-control" autocomplete="off">
                          </div>
                         </div>
                        <div class="col-sm-6">
                          <!-- select -->
  ...
  <!-- /.content-wrapper -->
    <script>
        ...
        $("#btn-submit").click(function(e){
            ...
            $.ajax({
               type: 'POST',
               url: '/ofw_admin/catalog/agencies/store',
