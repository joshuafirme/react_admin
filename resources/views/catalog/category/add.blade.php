                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="form-group">
                            ...
                            <input id="category_name" type="text" required name="category_name" class="form-control" autocomplete="off">
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="form-group">
                            ...
                            <input id="category_description" type="text" name="category_description" class="form-control" autocomplete="off">
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="form-group">
                            ...
                            <br>
                            <input type="color" id="code_color" name="code_color" value="#000000">
